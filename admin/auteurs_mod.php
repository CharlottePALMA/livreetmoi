          ...
          <table width="<?=$w?>" border="0" cellspacing="0" cellpadding="0">
            ...
            <form method="post" action="auteurs.php" enctype="multipart/form-data">
              ...
              <tr>
                ...
                <td align="left" valign="middle"><div align="left">
                  <input name="prenom" type="text" class="txtfieldxlarge" value="<?=$ligne['prenom']?>">
                </div></td>
              </tr>

              <tr>
                <td align="left" valign="middle"><div align="left"><b>Photo <?=$taille_image?></b></div></td>
                <td align="left" valign="middle"><div align="left">
                  <?
if ($ligne['photo']!="")
	{
	?>
	<a href="/data/<?=$ligne['photo']?>" data-fancybox-type="image" class="fancy"><img src="<?=vignette2("/data/".$ligne['photo'],200,200)?>"></a><br>
...
?>
              ...
              <tr>
                ...
                <b>BIO</b><br>
                  <textarea name="bio" class="editor" style="width:<?=($w-10)?>px;height:500px;" id="editor1"><?=$ligne['bio']?></textarea>
                </td>
              </tr>
